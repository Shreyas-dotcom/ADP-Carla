# Parallel Park a vehicle via waypointing in Carla
...
class CarlaParkVehicle(object):
    ...
    def __init__(self):
        ...
        self.vehicle.apply_control(carla.VehicleControl(throttle=0.4, brake=0.0))
        print(
            "OHH SHOOTT!!I JUST REMEMBERED.ELON MUSK HAS SHOWCASED THE CYBERTRUCK IN OUR TOWN...LETS GO CHECK IT OUT...")
    ...
    def run(self):
        ...
        try:
            rospy.wait_for_message("/carla/world_info", timeout=10.0)
